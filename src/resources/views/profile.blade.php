...
@section('content')
<x-fe-portlet id="Profile_Panel" class="m-0 m-l-15 m-r-15 h-100p">
    @empty($User)
                    ...
                    <div class="panel-body p-10">
                        <div class="text-center col-md-2 hidden-xs hidden-sm" style="min-height: 120px;">
                            <div class="bd-full img-circle  usrProfile {{$Editable?'editable':''}}">
                                <img src="{{app()->FeFrame->GetProfileImage(120,false,null,$User)}}"
                                    class="img-lg img-thumbnail img-responsive img-circle bg-light" alt="avatar">
                            </div>
                        </div>
